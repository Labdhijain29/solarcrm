  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dashboard-grid-metrics">
        ...
        <MetricCard icon={<FaUsers />} label="Sales Executives" value={salesExecutives.length} change="Users" changeColor="var(--sun)" />
      </div>
      ...
      {showCreate && <SalesExecutiveForm onClose={() => setShowCreate(false)} onCreated={refreshData} />}
