      ...
      <div className="dashboard-table-filters">
        <div className="dashboard-search">
          ...
          <input
            ...
            placeholder="Search name, phone, city, branch, IVRS..."
            value={search}
        ...
        {filtered.length === 0 ? (
          ...
          <>
            <table className="crm-table">
              <thead>
                <tr>
                  {['ID', 'Customer', 'City', 'Source', 'IVRS No.', 'Branch', 'Generated By / Through', 'kW', 'Stage', 'Status', 'Progress', 'Action'].map((heading) => <th key={heading}>{heading}</th>)}
                </tr>
              </thead>
              <tbody>
                {filtered.map((lead) => (
