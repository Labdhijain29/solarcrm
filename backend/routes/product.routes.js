...
router.post('/bulk', authorize('Admin', 'Stock Manager', 'Dispatch Manager'), bulkAddProducts);

router.route('/')
  .get(authorize('Admin', 'Stock Manager', 'Dispatch Manager', 'Installation Manager'), getProducts)
  .post(authorize('Admin', 'Stock Manager', 'Dispatch Manager'), createProduct);

router.route('/:id')
  .put(authorize('Admin', 'Stock Manager', 'Dispatch Manager'), updateProduct)
  .delete(authorize('Admin', 'Stock Manager', 'Dispatch Manager'), deleteProduct);
